    ...
    addExport: (exportTask) => {
        ...
        toast.info(
            <div className="w-full">
                <p className="text-sm font-semibold">Export Started</p>
                <p className="text-muted-foreground mt-0.5 text-sm">We'll notify you when your PDF is ready</p>
            </div>,
            {
                duration: 3000,
                ...
                if (updates.status === 'completed' && updates.downloadUrl) {
                    ...
                    toast.success(
                        <div className="w-full space-y-2">
                            <div>
                                ...
                                <p className="text-muted-foreground text-sm">Your PDF has been generated successfully</p>
                            </div>
                            <Button
                                variant="outline"
                                size="sm"
                    ...
                    toast.error(
                        <div className="w-full">
                            ...
                            <p className="text-muted-foreground mt-0.5 text-sm">{updates.error || 'Please try again'}</p>
                        </div>,
                        {
                            duration: 5000,
                            id: `export-failed-${id}`,
                        ...
                        toast.loading(
                            <div className="w-full space-y-2">
                                <div>
                                    ...
                                    <p className="text-muted-foreground text-sm">Please wait while we prepare your document</p>
                                </div>
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-muted-foreground text-xs font-medium">{updates.progress}%</span>
                                </div>
                            </div>,
                            {
                                duration: 2000,
