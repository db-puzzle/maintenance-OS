...
export const MeasurementUnitCategories: Record<UnitCategory, MeasurementUnit[]> = {
    ...
    'Fluxo Luminoso': [{ value: 'lm', label: 'Lúmen (lm)', category: 'Fluxo Luminoso' }],
    Iluminância: [
...
export const MeasurementUnits = Object.values(MeasurementUnitCategories).flatMap((units) => units.map((unit) => unit.value));
