            ...
            content: (
                <div className="mt-6 space-y-4">
                    <EntityDataTable
                        ...
                        columns={[
                            {
                                ...
                                render: (value, row) => <div className="font-medium">{(row as Asset).tag}</div>,
                            },
                            {
                                key: 'area',
                                label: 'Área',
                                ...
                                render: (value, row) => <span className="text-muted-foreground text-sm">{(row as Asset).area?.name ?? '-'}</span>,
                            },
                            {
                                key: 'manufacturer',
                                label: 'Fabricante',
                                ...
                                render: (value, row) => <span className="text-muted-foreground text-sm">{(row as Asset).manufacturer?.name ?? '-'}</span>,
                            },
                            {
                        ...
                        onRowClick={(row) => router.visit(route('asset-hierarchy.assets.show', (row as Asset).id))}
                    />
                    <EntityPagination
                        pagination={{
