...
export default function ImportEquipment() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await axios.post(route('asset-hierarchy.equipamentos.import.analyze'), formData, {
                headers: {
    ...
    const handleImport = async () => {
        ...
        const progressInterval = setInterval(async () => {
            try {
                const progressResponse = await axios.get(route('asset-hierarchy.equipamentos.import.progress'));
        ...
        try {
            const response = await axios.post(route('asset-hierarchy.equipamentos.import.data'), {
                data: csvData.data,
    ...
    const handleCancelImport = async () => {
        try {
            ...
            await axios.post(route('asset-hierarchy.equipamentos.import.data'), {
                data: csvData?.data,
                mapping: fieldMapping,
                cancel: true
            }, {
    ...
    React.useEffect(() => {
        ...
        const handleUnload = () => {
            if (importing) {
                ...
                navigator.sendBeacon(route('asset-hierarchy.equipamentos.import.data'), formData);
            }
        };
