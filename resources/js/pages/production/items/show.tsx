    ...
    const handleCategorySheetSuccess = () => {
        ...
        router.reload({
            ...
            onSuccess: (page) => {
                ...
                const createdCategoryId = (page.props as { flash?: { created_category_id?: number } }).flash?.created_category_id;
                        ...
                        <div className="py-6">
                            {whereUsedBoms ? (
                                <div className="space-y-4">
                                    ...
                                    <EntityDataTable
                                        data={whereUsedBoms.data as unknown as Array<Record<string, unknown>>}
                                        columns={[
                                            {
                                                key: 'bom_number',
                                                label: 'BOM',
                        ...
                        <div className="py-6">
                            {manufacturingOrders ? (
                                <div className="space-y-4">
                                    ...
                                    <EntityDataTable
                                        data={manufacturingOrders.data as unknown as Array<Record<string, unknown>>}
                                        columns={[
                                            {
                                                key: 'order_number',
