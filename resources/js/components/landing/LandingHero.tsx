...
export function LandingHero() {
    ...
    return (
        <LandingContainer className="pb-16 pt-20 text-center lg:pt-32">
            <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl dark:text-white">
                ...
                <span className="relative whitespace-nowrap text-blue-600 dark:text-blue-400">
                    <svg
                        aria-hidden="true"
                        viewBox="0 0 418 42"
                        className="absolute left-0 top-2/3 h-[0.58em] w-full fill-blue-300/70 dark:fill-blue-500/30"
            ...
            <div className="mt-10 flex justify-center gap-x-6">
                {auth.user ? (
                    <LandingButton href={route('home')}>Go to Dashboard</LandingButton>
                ) : (
                    <>
                        <LandingButton href={route('register')}>Get 6 months free</LandingButton>
                        <LandingButton
                        ...
                        >
                            <svg
                                aria-hidden="true"
                                className="h-3 w-3 flex-none fill-blue-600 group-active:fill-current dark:fill-blue-400"
                            >
