            ...
            {features.map((feature) => (
                <div key={feature.summary}>
                    ...
                    <div className="relative mt-10 pb-10">
                        ...
                        <div className="relative mx-auto w-[52.75rem] overflow-hidden rounded-xl bg-white shadow-lg shadow-slate-900/5 ring-1 ring-slate-500/10 dark:bg-slate-800 dark:ring-slate-500/20">
                            <img
                                className="w-full"
                                src={feature.image}
                                alt=""
        ...
        <TabGroup className="hidden lg:mt-20 lg:block">
            {({ selectedIndex }) => (
                <>
                    ...
                    <TabPanels className="relative mt-20 overflow-hidden rounded-[2rem] bg-slate-200 px-14 py-16 xl:px-16 dark:bg-slate-800">
                        <div className="-mx-5 flex">
                            {features.map((feature, featureIndex) => (
                                ...
                                >
                                    <div className="w-[52.75rem] overflow-hidden rounded-xl bg-white shadow-lg shadow-slate-900/5 ring-1 ring-slate-500/10 dark:bg-slate-900 dark:ring-slate-500/20">
                                        <img
                                            className="w-full"
                                            src={feature.image}
                                            alt=""
                        ...
                        <div className="pointer-events-none absolute inset-0 rounded-[2rem] ring-1 ring-inset ring-slate-900/10 dark:ring-white/10" />
                    </TabPanels>
                </>
            )}
        </TabGroup>
...
export function LandingSecondaryFeatures() {
    return (
        <section
