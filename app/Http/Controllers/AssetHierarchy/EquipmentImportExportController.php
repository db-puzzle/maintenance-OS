...
class EquipmentImportExportController extends Controller
{
    ...
    {
        return Inertia::render('asset-hierarchy/equipamentos/import');
    }

    public function export()
    {
        return Inertia::render('asset-hierarchy/equipamentos/export');
    }
    ...
    public function exportData(Request $request)
    {
        ...
        $downloadUrl = route('asset-hierarchy.equipamentos.export.download', ['filename' => $filename]);
