...
class UserManagementService
{
    ...
    {
        $roles = $user->isAdministrator()
            ? Role::orderBy('name')->get(['id', 'name', 'is_system', 'display_name', 'description'])
            : Role::where('name', '!=', 'Administrator')->orderBy('name')->get(['id', 'name', 'is_system', 'display_name', 'description']);

        // Add metadata for entity-scoped roles
