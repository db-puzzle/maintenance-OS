...
return [
    ...
    'database' => [
         ...
         */
        'template_tenant_connection' => env('TENANCY_DB_TEMPLATE_CONNECTION', env('DB_CONNECTION', 'pgsql')),
    ...
    'redis' => [
        ...
        'prefixed_connections' => [ // Redis connections whose keys are prefixed, to separate one tenant's keys from another.
            'default', // ENABLED: Prefix session keys with tenant ID for true isolation
        ],
    ],
     ...
     * To configure their behavior, see the config keys below.
     */
    'tenant_database_creation_disabled' => false,

    /*
     * Tenant creation pipeline - Jobs to run after a tenant is created
     */
    'jobs' => [
        // Jobs to be run when a tenant is created
        ...
        \App\Jobs\CreateTenantAdmin::class, // Will seed admin user from metadata
    ],
