...
/**
 * Seeder for tenant-specific permissions.
 * Creates all application permissions within the tenant database context.
 */
class TenantPermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::transaction(function () {
            ...
            // Production Order Management permissions
            ...
            // Create all permissions in tenant database
            ...
            $this->command->info('Tenant permissions created successfully.');
